...
class UpdateNoteFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            param1 = it.getString(com.example.notestakingapplication.ARG_PARAM1)
            param2 = it.getString(com.example.notestakingapplication.ARG_PARAM2)
        }
    }
        ...
        fun newInstance(param1: String, param2: String) =
            UpdateNoteFragment().apply {
                arguments = Bundle().apply {
                    putString(com.example.notestakingapplication.ARG_PARAM1, param1)
                    putString(com.example.notestakingapplication.ARG_PARAM2, param2)
                }
            }
    }
}